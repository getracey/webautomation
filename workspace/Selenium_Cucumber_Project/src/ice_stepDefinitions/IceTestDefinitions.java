...

{
	...
	public void the_Report_Builder_module_is_opened() throws Throwable {		
		...
		driver.manage().window().maximize();
		//driver.get("https://push-bk.ice.stats.com");
		driver.get("http://dev-nfbc.stats.com");
		Thread.sleep(10000);
//      driver.findElement(By.xpath("//a[@class='btnSmall btnBlue']")).click();
//    Runtime.getRuntime().exec("c:\\autoit\\HandleAuth.exe");
      ...
      driver.getTitle();
      driver.findElement(By.xpath(".//*[@id='siteMain']/div[1]/table[1]/tbody/tr[2]/td[2]/a")).click();
      driver.getTitle();
      Actions action = new Actions(driver);
      WebElement settings = driver.findElement(By.xpath("//ul[@class='clearfix']/li[8]"));
      action.moveToElement(settings).click().build().perform();
      driver.findElement(By.xpath("//ul[@class='clearfix']/li[8]/ul/li[1]/a")).click();
//    driver.findElement(By.xpath(".//*[@id='siteContainer']/header/nav/ul/li[8]/ul/li[1]/a")).click();
      WebElement text_box = driver.findElement(By.xpath("//input[@name='team_abv']"));
      text_box.clear();
      text_box.sendKeys("XYZ");
      driver.getTitle();
      driver.findElement(By.name("team_abv")).clear();
      driver.findElement(By.name("team_abv")).sendKeys("T00");
      driver.findElement(By.xpath(".//*[@id='siteMain']/div[1]/div/table[2]/tbody/tr/td[2]/table/tbody/tr[3]/td/button")).click();
	...
	public void a_report_is_created_in_Report_Builder() throws Throwable {
		...
		driver.findElement(By.xpath("//*[@id='ddlTeams1']/div/li")).click();
		
		driver.findElement(By.xpath("//*[@id='ddlTeams1']/div/li/ol/li[2]")).click();//Select Team Boston
		driver.findElement(By.xpath("//*[@id='ddlPlayers1']/div/li")).click();
		driver.findElement(By.xpath("//*[@id='ddlPlayers1']/div/li/ol/li[13]/input")).click();//Select Player I.Thomas
		driver.findElement(By.xpath("//*[@id='ddlPlayers1']/div/li/ol/li[1]/input")).click();//Select Player A.Bradley
		driver.findElement(By.xpath("//*[@id='ddlPlayers1']/div/li/ol/li[2]/input")).click();//Select Player J.Brown
		driver.findElement(By.xpath("//*[@id='ddlPlayers1']/div/li/ol/li[3]/input")).click();//Select Player J.Crowder
		driver.findElement(By.xpath("//*[@id='ddlPlayers1']/div/li/ol/li[5]/input")).click();//Select Player A.Horford
		driver.findElement(By.xpath("//*[@id='ddlPlayers1']/div/li/ol/li[6]/input")).click();//Select Player D.Jackson
	
		driver.findElement(By.xpath("//*[@id='ddlTeams1']/div/li")).click();
		driver.findElement(By.xpath("//*[@id='ddlTeams1']/div/li/ol/li[5]")).click();//Select Team Chicago
		driver.findElement(By.xpath("//*[@id='ddlPlayers1']/div/li")).click();
		driver.findElement(By.xpath("//*[@id='ddlPlayers1']/div/li/ol/li[1]/input")).click();//Select Player J.Butler
		driver.findElement(By.xpath("//*[@id='ddlPlayers1']/div/li/ol/li[3]/input")).click();//Select Player M.Carter Williams
		driver.findElement(By.xpath("//*[@id='ddlPlayers1']/div/li/ol/li[5]/input")).click();//Select Player T.Gibson
		driver.findElement(By.xpath("//*[@id='ddlPlayers1']/div/li/ol/li[7]/input")).click();//Select Player R.Lopez
		driver.findElement(By.xpath("//*[@id='ddlPlayers1']/div/li/ol/li[9]/input")).click();//Select Player N.Mirotic
		driver.findElement(By.xpath("//*[@id='ddlPlayers1']/div/li/ol/li[11]/input")).click();//Select Player R.Rondo
		driver.findElement(By.xpath("//*[@id='ddlPlayers1']/div/li/ol/li[13]/input")).click();//Select Player D.Wade
		...
		driver.findElement(By.xpath("//*[@id='divSubEventsHA']/div[2]/input")).click();//Home split
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='rptBuildStats']/div[2]/div[17]/div[3]/span")));
		driver.findElement(By.cssSelector("#rptBuildStats > div.rptBuildStats > div:nth-child(9) > div.RptBuild-plusIcon > span")).click();//Close Touches Stat +
